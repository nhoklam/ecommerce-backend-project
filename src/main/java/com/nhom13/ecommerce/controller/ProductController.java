...
import com.nhom13.ecommerce.service.ProductService;
...
public class ProductController {
    ...
    @PreAuthorize("hasRole('ADMIN')")
    public ResponseEntity<ProductVariantDTO> addVariant(@PathVariable Long productId, @RequestBody ProductVariantDTO variantDTO) {
